...
import {initialCards, containerElements, popupPreview} from '../utils/constants.js';
...
const cardList = new Section(
  {
    items: initialCards,
    renderer: (cardItem) => {
      const card = new Card(cardItem, '.template_type_default', popupImage.open);
